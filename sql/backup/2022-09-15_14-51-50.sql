...
INSERT INTO `admin_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`) VALUES ('1', '127.0.0.1', 'webmaster', '$2y$08$/X5gzWjesYi78GqeAv5tA.dVGBVP7C1e1PzqnYCVe5s1qhlDIPPES', NULL, NULL, NULL, NULL, NULL, NULL, '1451900190', '1663242505', '1', 'Recruitment Admin', NULL);
...
INSERT INTO `job_posts` (`id`, `category`, `hiring_manager`, `practice_manager`, `location`, `business-unit`, `project`, `title`, `skill`, `practice`, `sub-practice`, `content_brief`, `content`, `status`, `publish_time`) VALUES ('2', '0', '8', '0', '0', '0', '0', '', '0', '0', '0', '', '', '0', '0000-00-00 00:00:00');
...
INSERT INTO `job_practices` (`id`, `practice`) VALUES ('6', 'Networking');
INSERT INTO `job_practices` (`id`, `practice`) VALUES ('7', 'Workplace Services and  DCTS');
INSERT INTO `job_practices` (`id`, `practice`) VALUES ('8', 'GPST');
INSERT INTO `job_practices` (`id`, `practice`) VALUES ('9', 'Education Services');
